...
const st = StyleSheet.create({
  ...
  addEmptyBtn: { backgroundColor: '#A8862B', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 12 },
  ...
  submitBtn: { backgroundColor: '#A8862B', borderRadius: 12, paddingVertical: 14, alignItems: 'center', marginTop: 8 },
