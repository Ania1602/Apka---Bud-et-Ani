...
const s = StyleSheet.create({
  ...
  depositBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#A8862B', borderRadius: 12, paddingVertical: 12 },
  ...
  accChipActive: { backgroundColor: '#A8862B' },
  accChipText: { fontSize: 13, color: '#6B5D52' },
  accChipTextActive: { color: '#FFF' },
  submitBtn: { backgroundColor: '#A8862B', borderRadius: 12, paddingVertical: 14, alignItems: 'center' },
